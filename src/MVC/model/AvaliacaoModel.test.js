...
import Avaliacao from "../MVC/model/AvaliacaoModel";

const aval = new Avaliacao()

test("expected to properly format the number into valid sql DECIMAL(2,3)",() => { 
...
test("it should create an Avaliacao Object with that feed data", () => {
    ...
    expect(new Avaliacao(data)).toMatchObject(checker)
})